...
/* printInvalidExpressionBra
   : 괄호 안에 오는 식이 잘못된 오류를 출력한다 */
void printInvalidExpressionBra(){
    printParseErrHeading();
    printf("%s\n", "invalid expression in bracket");
}

/* printInvalidExpression
   : expression 식이 잘못된 오류를 출력한다 */
void printInvalidExpression(){
    printParseErrHeading();
    printf("%s\n", "invalid expression");
}